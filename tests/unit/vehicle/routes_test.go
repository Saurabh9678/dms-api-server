...
func (m *mockRoutesService) SellVehicle(ctx context.Context, sellerUserID, vehicleID uint64, req *vehicle.SellVehicleRequest) (*vehicle.SellVehicleResponse, error) {
