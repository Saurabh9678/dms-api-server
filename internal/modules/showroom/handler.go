...
func (h *Handler) GetShowroom(c *gin.Context) {
	...
	resp, err := h.service.GetShowroomByID(c.Request.Context(), callerRoles, showroomID)
	if err != nil {
		response.FromError(c, err)
		return
	}

	response.OK(c, "showroom fetched", resp)
}
